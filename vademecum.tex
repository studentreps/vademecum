...
\begin{itemize}
	\item the \textbf{Students Secretariat} is devoted to the solution of ``general'' problems, like the enrollment to the School, tax declaration procedures, etc. (e-mail address: \linkemail{phd@sissa.it});
	\item the \textbf{Scientific Secretariat} administrates all issues (missions, booking of lecture rooms, etc.): \href{https://www.sissa.it/scientific-secretariat}{here} is the information relating to the \textbf{Scientific Secretariat} and \href{https://www.sissa.it/articolazione-degli-uffici}{here} you can find the \textbf{general organization} of each office.
\end{itemize}
For more specific issues related to your PhD sector or Area, the people in charge are the following:
\begin{itemize}
	\item the \textbf{PhD Coordinator} (together with the Teaching Board) is in charge of all the administrative issues of your PhD course, for example the coordination of teaching activities, the approval of the plan of studies, the qualifying/progress exams, the approval of missions (when funded by specific PhD course funds), etc.
...
SISSA has an agreement with Intesa San Paolo which will speed up the process of opening a new account. The documents needed to open a new bank account are as follows:
\begin{itemize}
    \item your Italian tax code (\textit{codice fiscale});
    \item the receipt that the post office gave you when you applied for your permit of stay (\textit{permesso di soggiorno});
...
Whether you are an Italian or a foreign student, you should comfortably find an accommodation in Trieste within a few days from your arrival. If you are a foreign student and not sure how to rent an apartment in Trieste, you can ask SISSA's housing service for help: you can contact the Housing facility staff by e-mail at \linkemail{housing@sissa.it} which should support you choosing among the available accommodation opportunities (apartments and rooms). \\
Informal announcements of rooms or apartments available, posted also by students looking for fellow students to share, can be found at the 2nd floor of SISSA's Main Building, in front of the Students Secretariat (Room 222).\\
...
Once you find a house but realize that you don't have dishes, cutlery, cookware, bed sheets, towels and so on, you can go to AZCASA, a series of shops that can supply all these things to you. If you prefer, on Saturdays and Sundays a bus leaves from Piazza Oberdan square towards TIARE shopping center in Villesse (a city reasonably far from Trieste): the ticket is about 2 euros and can be bought directly on the bus! For more information, search for ``Shopping bus - Trieste'' on Google.


\section{Applying for residency in Trieste}

If you want to apply for permanent residence in Italy, at \href{https://www.comune.trieste.it/it/servizi-227101/anagrafe-iscrizione-per-residenza-210458}{this} link you find all the instructions needed to apply for the residence registration, the request form to be filled out and additional files listing the documentation needed. In particular:
\begin{itemize}
...
\begin{itemize}
	...
	\item Physics Area
		\begin{itemize}
			\item \href{https://www.sissa.it/sbp/webtools/doorlabel/door.php}{Molecular and Statistical Biophysics  (MSB)}
		...
		\end{itemize}
	\item \href{https://www.sissa.it/it/ricerca/neuroscienze}{Neuroscience Area}
\end{itemize} 
...
\begin{figure}
	\vspace*{-12pt}
	\includegraphics[height=1.05\textheight,center]{figures/StudentPoster.pdf}
\end{figure}
...
Non-EU students are entitled to a reimbursement of the amount of money paid to register with the \textbf{Italian national health system}, up to a maximum of \EUR{} $700$ per year.
...
\textbf{Note 2:} It is not possible to use the app bookAmeal to pay in the SISSA canteen. The pay service can be used only for the canteens and reastaurants listed on ARDiS website (\href{https://www.ardis.fvg.it/contenuti.php?view=page&id=214#scheda532}{link}), since an agreement between ARDiS and the company that cooks the meals is needed.
...
\begin{itemize}
	\item SISSA's psychologists, Dr.\@ Erica Contantini \linkemail{ecostant@sissa.it}
