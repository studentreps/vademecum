...
\chapter{\texorpdfstring{\faGraduationCap\ }{} A Look after Your PhD}
...
\section{Coursera Online Platform}
\section{Masters in High-Performance Computing and Science Communication}
\section{Convention with UniTS on the 24 CFU training for teaching}
...
\begin{enumerate}
	\item get your SPID code, which allows to access all the online services of the Italian public administration. Following \href{https://www.spid.gov.it/en/}{this link}, you can get your SPID code (needed to log into your personal \href{https://www.inps.it/myinps/default.aspx?accessoinps=1}{INPS} webpage and get registered to ``Gestione Separata''). Note that it can take up to a few weeks to get your SPID number; therefore, the sooner you do it, the better it is. If you already have an INPS PIN, you do not need to get a SPID number and you can still log into the INPS portal by using your PIN code;
...
\begin{itemize}
    \item \underline{This section concerns students \textit{with} residence in Italy.}
    ...
    \item \underline{This section concerns students \textit{without} residence in Italy.}
...
\textbf{If you are a first year student}, you should go to the ARDiS office and get your ARDiS card or ``Tessera Mensa'' (that allows you to have proper discounts at the canteen) only after approximately one week after the completion of the procedure outlined above.
