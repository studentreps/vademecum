...
As of \today the bar is fully operational, and open from 9:30 to 15:00; the canteen is instead still closed. However, you can get take-away meals at the bar if you book them in advance (by 11:00) in one of the following ways:
\begin{itemize}
...
\end{itemize}
The meals can be collected from 12:00 to 14:00.
