...
\section{Temporary unemployment benefit}

If you do not have a Gestiona Separata completed -- it is the first step to do.
\begin{itemize}
   \item The first way is to go directly to INPS office Trieste ( Via Sant'Anastasio, 5,), nearby busstop 38. Probably I didn't even fix an appointment- just came and had a talk. In principle, they should give you INPS code. But I had some problems, so I have obtained a SPID code (see (2.) )
   \item One can obtain a SPID code online having the Tessera Sanitaria (your health card). If it is expired, it's also fine, the main thing is its' number. Although you should fill in the date of expiration of the health card of this year (like, September 2022 or December 2022), even it has already expired -- they do not check it further, the thing which is needed is a number.
   \item Once you got your SPID, you go to the INPS website (https://www.inps.it/) and complete the procedure "Gestiona Separata".
   \item Then, you go to Anpal website (https://www.anpal.gov.it/did) and complete the procedure "Did online"-- at the end they will ask you to send an email to schedule an appointment to the adress (cpi.trieste@regione.fvg.it). They will reply to you with a date of the appointment . Then you will go to the address (Scala dei Cappuccini, 1) and get a bunch of documents which one can also use to get a job seeking permit of stay.
   \item Finally, you should make a diss-coll (https://www.inps.it/prestazioni-servizi/dis-coll-indennita-mensile-di-disoccupazione) procedure, where you will fill in with your IBAN , which is for getting the unemployment benefit.
    As I have understood, one can do 4. and 5. at the same time, more or less.
\end{itemize}
...
\section{Prayer room}
There is a room at the 4th floor, left wing, next to the toilet, that is possible to use for meditation or praying. Only one person is allowed inside.
